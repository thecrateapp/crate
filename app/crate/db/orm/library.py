...
class LibraryArtist(Base):
    ...
    id: Mapped[int | None] = mapped_column(BIGINT, unique=True)
    ...
    album_count: Mapped[int | None] = mapped_column(Integer, default=0)
    track_count: Mapped[int | None] = mapped_column(Integer, default=0)
    total_size: Mapped[int | None] = mapped_column(BIGINT, default=0)
    ...
    bandcamp_url_updated_at: Mapped[datetime | None] = mapped_column(
        DateTime(timezone=True)
    )
...
class LibraryAlbum(Base):
    ...
    track_count: Mapped[int | None] = mapped_column(Integer, default=0)
    total_size: Mapped[int | None] = mapped_column(BIGINT, default=0)
    total_duration: Mapped[float | None] = mapped_column(Float, default=0.0)
    formats_json: Mapped[list[str] | None] = mapped_column(JSON)
    year: Mapped[str | None] = mapped_column(Text)
    genre: Mapped[str | None] = mapped_column(Text)
    has_cover: Mapped[int | None] = mapped_column(Integer, default=0)
...
class LibraryTrack(Base):
    ...
    analysis_state: Mapped[str | None] = mapped_column(Text, default="pending")
    bliss_state: Mapped[str | None] = mapped_column(Text, default="pending")
