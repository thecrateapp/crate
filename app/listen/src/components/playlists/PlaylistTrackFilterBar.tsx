    ...
    <div className={cn("flex w-full", className)}>
      <div className="relative min-w-0 flex-1">
        ...
        <input
          ...
          className="h-11 w-full rounded-lg border border-border-quiet bg-surface-canvas/10 pl-10 pr-28 text-sm text-foreground outline-none transition-[border-color,box-shadow] placeholder:text-muted-foreground focus:border-primary/40 focus:ring-2 focus:ring-primary/20 sm:pr-36"
        />
        ...
        {filtering ? (
          <button
            ...
            className="absolute right-24 top-1/2 flex h-7 w-7 -translate-y-1/2 items-center justify-center rounded-full text-muted-foreground transition-colors hover:bg-text-primary/8 hover:text-text-primary/75 sm:right-32"
