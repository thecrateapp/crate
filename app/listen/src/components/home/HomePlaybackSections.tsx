...
function HomeTrackRowAction({
  ...
  return (
    <div
      ...
      className="group/row flex w-full cursor-pointer items-center gap-3 rounded-lg px-3 py-2 text-left transition-colors hover:bg-white/5 focus-visible:bg-white/5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/40"
    >
...
function HomeQueueCardAction({
  ...
  return (
    <div
      ...
      onContextMenu={actionMenu.handleContextMenu}
      className="group w-[220px] flex-shrink-0 cursor-pointer overflow-hidden rounded-xl border border-white/10 bg-white/[0.03] text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/40"
    >
      <div className="flex items-center gap-3 p-3">
        <div className="relative h-16 w-16 shrink-0">
          <TrackCoverThumb
            ...
            className="absolute inset-0 rounded-xl"
          />
          <div className="absolute inset-0 flex items-center justify-center rounded-xl bg-black/0 transition-colors group-hover:bg-black/45">
            <Play
              size={18}
              fill="currentColor"
...
export function ContinueListeningSection({
  ...
  if (!continueLead) {
    return (
      <div className="overflow-hidden rounded-[12px] border border-white/10 bg-[radial-gradient(circle_at_top_left,rgba(6,182,212,0.18),transparent_50%),linear-gradient(180deg,rgba(255,255,255,0.04),rgba(255,255,255,0.02))] p-6">
  ...
  return (
    <section className="space-y-4">
      ...
      <div className="grid gap-4 lg:grid-cols-[minmax(0,1fr)_minmax(0,0.9fr)] xl:grid-cols-[minmax(0,1fr)_minmax(320px,0.9fr)]">
        <div className="overflow-hidden rounded-[12px] border border-white/10 bg-[radial-gradient(circle_at_top_left,rgba(6,182,212,0.14),transparent_42%),linear-gradient(180deg,rgba(255,255,255,0.05),rgba(255,255,255,0.02))] p-5">
