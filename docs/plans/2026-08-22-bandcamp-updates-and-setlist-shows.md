...
- El read model de `/api/me/feed` expone ahora el contexto de clusters aceptados con miembros, razones, confianza, procedencia, visibilidad y estado aplicado; el contexto se conserva aunque la deduplicación de releases elija como ganador una fuente local. Los clusters históricos malformados se ignoran sin romper el feed.
